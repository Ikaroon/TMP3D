...
namespace Ikaroon.TMP3D
{
	...
	public class TMP3D_HandlerUI : MonoBehaviour
	{
		public TextMeshProUGUI TMP { get { return m_tmp; } }
		...
		public void UpdateMeshValues()
		{
			...
			for (int i = 0; i < m_tmp.textInfo.meshInfo.Length; i++)
			{
				...
				for (int j = 0; j < count; j++)
				{
					...
					var rt = new Vector4(r.x, r.y, r.z, r.w);
					l[vertexIndex + 0] = rt;
					l[vertexIndex + 1] = rt;
					l[vertexIndex + 2] = rt;
					l[vertexIndex + 3] = rt;
			...
			m_tmp.SetVerticesDirty();
			m_tmp.SetLayoutDirty();
		}
